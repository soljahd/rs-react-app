...
describe('UncontrolledForm', () => {
  const addUncontrolledFormMock = vi.fn();
  ...
  beforeEach(() => {
    ...
    mockedUseFormStore.mockReturnValue({
      addUncontrolledForm: addUncontrolledFormMock,
      countries: ['USA', 'Canada', 'UK'],
    } as unknown as Store);
  });

  it('should render all form fields', () => {
    render(<UncontrolledForm onClose={onCloseMock} />);
  ...
  it('should render Passwords must match message', () => {
    render(<UncontrolledForm onClose={onCloseMock} />);
  ...
  it('should submit valid form data', async () => {
    ...
    await waitFor(() => {
      expect(addUncontrolledFormMock).toHaveBeenCalledWith(
