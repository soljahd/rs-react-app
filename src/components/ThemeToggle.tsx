...
export const ThemeToggle = () => {
  ...
  return (
    ...
    >
      <img src="./moon.svg" alt="moon" className={`absolute top-1/2 left-1 h-6 w-6 -translate-y-1/2`} />
      <img src="./sun.svg" alt="sun" className={`absolute top-1/2 right-1 h-6 w-6 -translate-y-1/2`} />
